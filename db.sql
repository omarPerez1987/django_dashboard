...
-- Volcando datos para la tabla dashboard_django.django_admin_log: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla dashboard_django.django_content_type: ~9 rows (aproximadamente)
...
INSERT INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
	...
	(34, 'website', '0001_initial', '2024-02-15 13:48:36.169455');
...
-- Volcando estructura para tabla dashboard_django.website_booking
CREATE TABLE IF NOT EXISTS `website_booking` (
  ...
  PRIMARY KEY (`id`),
  KEY `website_booking_idRoom_id_26d2e5fd_fk_website_room_id` (`idRoom_id`),
  CONSTRAINT `website_booking_idRoom_id_26d2e5fd_fk_website_room_id` FOREIGN KEY (`idRoom_id`) REFERENCES `website_room` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla dashboard_django.website_booking: ~0 rows (aproximadamente)

-- Volcando estructura para tabla dashboard_django.website_contact
...
-- Volcando datos para la tabla dashboard_django.website_contact: ~0 rows (aproximadamente)
INSERT INTO `website_contact` (`id`, `photo`, `date`, `hour`, `name`, `last_name`, `email`, `telephone`, `archived`, `review`) VALUES
...
-- Volcando estructura para tabla dashboard_django.website_order
...
-- Volcando datos para la tabla dashboard_django.website_order: ~0 rows (aproximadamente)

-- Volcando estructura para tabla dashboard_django.website_room
CREATE TABLE IF NOT EXISTS `website_room` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `photo` varchar(255) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `website_room_chk_1` CHECK ((`price` >= 0)),
  CONSTRAINT `website_room_chk_2` CHECK ((`discount` >= 0))
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla dashboard_django.website_room: ~0 rows (aproximadamente)
INSERT INTO `website_room` (`id`, `photo`, `room`, `bed`, `facilities`, `description`, `price`, `discount`, `cancel`, `status`) VALUES
